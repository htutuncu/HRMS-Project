package com.hrms.project.business.constants;
...
public class Messages {
    ...
    //Job seekers
    public static String JOB_SEEKER_SUCCESS_DATA_LISTED = "Job seekers listed";
    public static String JOB_SEEKER_SUCCESS_ADDED = "Job seeker added";
    public static String JOB_SEEKER_ERROR_NAME_IS_BLANK = "Job seeker's name is blank";
    public static String JOB_SEEKER_ERROR_SURNAME_IS_BLANK = "Job seeker's surname is blank";
